        ...
        <div class="column lg-12">
            ...
            <article class="entry format-standard">
                ...
                <div class="entry__media">
                    <figure style="text-align:center!important;"class="featured-image">
                        <img style="width: 600px;" src="{{ asset('storage/images/'.$data['post']->image) }}" alt="">
                    </figure>
                </div>
                        ...
                        <ol class="commentlist">
                            ...
                            @foreach($data['post']->comments as $comment)
                                <li class="depth-1 comment">
                                    <div class="comment__content column lg-12" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;padding:20px 5px 5px 40px;">
